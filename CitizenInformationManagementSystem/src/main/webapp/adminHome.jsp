...
//---------------------------------------------------
                     ...
                     $("#finally-delete").on("click", function () {
                                    $.get("http://localhost:8080/CitizenInformationManagementSystem/api/admin/deletecitizen", {citizenId: $("#delete-citizen-modal-id").html(), access_token: token}, function (data) {
                                        $("#delete-citizen-modal").modal("hide");
                                        $("#citizens").modal("hide");
                                        alert($("#delete-citizen-modal-id").html()+" : "+data);
                                    });
                                });
