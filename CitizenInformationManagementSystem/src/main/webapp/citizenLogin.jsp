...
<html>
    ...
    <body>
        <div class="container">
            <h1>This is the Login Page for the Citizen</h1>

            <form  id="login-form" name="login-form" method="post">

                <h3>Enter Citizen Sign in details : </h3>
                <div class="form-group">
                    <label>Citizen userName</label>
                    <input type="text" name="userName" id="userName" required="required" placeholder="Citizen Username" class="form-control"/>
                </div>
                <div class="form-group">
                    <label>Citizen password</label>
        ...
        <script>
            $(document).on("ready", function () {
                ...
                $("#submitForm").on("click", function () {
                    $.post("http://localhost:8080/CitizenInformationManagementSystem/api/citizen/logincitizen", $("#login-form").serialize(), function (data) {
                        if (data !== "null") {
                            location.href = "citizenHome.jsp?access_token=" + data;
                        } else {
                            $("#userName").val("");
                            $("#password").val("");
